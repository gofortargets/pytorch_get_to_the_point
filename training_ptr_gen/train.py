...
class Train(object):
    ...
    def train_one_batch(self, batch: Batch):
        ...
        # add input text to encoder forward
        encoder_outputs, encoder_feature, encoder_hidden = self.model.encoder(batch.enc_bert_input, batch.enc_bert_mask,
                                                                              enc_batch, enc_lens)
        ...
        for di in range(min(max_dec_len, config.max_dec_steps)):
            ...
            final_dist, s_t_1,  c_t_1, attn_dist, p_gen, next_coverage = \
                self.model.decoder(batch.dec_bert_input, batch.dec_bert_mask,
                                   y_t_1, s_t_1,
